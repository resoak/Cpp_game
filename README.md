...
- 感知器學習：感知器會在波次結束後根據戰鬥結果調整 `w1`、`w2` 與 `bias`，並用高輸出強化下游砲塔火力。
...
| 感知器 | `PCT` | 90 CR | 學習敵人逼近砲塔的時機，輸出越高越能強化下游砲塔 |
...
2. 將邏輯閘或感知器輸出接到砲塔，砲塔收到大於 0.5 的訊號才會開火；PCT 輸出越高，還會額外提高下游砲塔火力並縮短冷卻。
